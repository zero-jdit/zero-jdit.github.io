...
const projectsData = [
  {
    title: "GST 통합물성관리시스템 구축",
    period: "2025.11 ~ 2026.04",
    client: "효성티엔에스(주)",
    role: "PL",
    desc: "GST 고기능성 안전 및 물성 정보 실시간 트래킹 모듈 개발 및 품질 관리 통합 시스템 구축 PL.",
    tags: ["C# 2017", "물성관리", "PL"],
    icon: Activity,
    color: "text-rose-400",
    bg: "bg-rose-400/10",
  ...
  },
  {
    ...
    client: "효성티엔에스(주)",
    role: "PL",
    desc: "균주 배양 이력 및 라이프사이클 추적 모니터링 관리 정성/정량 데이터 파이프라인 구축 PL.",
  ...
  },
  {
    ...
    client: "효성티엔에스(주)",
    role: "PL",
    desc: "원사, 가공재고 실시간 트래킹 및 창고관리시스템(WMS)의 선입선출 자동화 유기적 파이프라인 구축 PL.",
  ...
  {
    title: "효성필름 IT 시스템 구축",
    period: "2023.08 ~ 2023.10",
    client: "효성티앤에스㈜",
    role: "PL",
    desc: "필름 제조 법인의 IT 기간 시스템(ERP/MES) 기획 분석 및 글로벌 공정 최적화 조율 솔루션 구축 PL.",
    tags: ["Delphi XE 10", "IT시스템", "PL"],
    icon: Network,
    color: "text-indigo-400",
    bg: "bg-indigo-400/10",
  ...
  },
  {
    ...
    client: "효성티앤에스㈜",
    role: "PL",
    desc: "해외 생산 거점의 고기능성 필름 코팅/슬리팅 공정별 수율 예측 정밀 모니터링 시스템 기능 보완 및 최적화 PL.",
          ...
          <section id="about" className="scroll-mt-24">
            ...
            <FadeUp>
              <p className="text-slate-300 leading-relaxed text-lg lg:text-xl font-light">
                ...
                기반으로, 기술적 깊이와 실무 경험을 통해 복잡한 문제를 가장 효율적인 형태로 풀어냅니다.
              </p>
            </FadeUp>
          </section>
